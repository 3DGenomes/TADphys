...
from taddyn.utils.tadmaths        import newton_raphson
from taddyn                       import __version__ as version
...
class StructuralModel(dict):
    ...
    #                model (:func:`taddyn.utils.extraviews.color_residues`)
    #              * '**tad**' to color particles according to the TAD they belong to
    #                (:func:`taddyn.utils.extraviews.tad_coloring`)
    #              * '**border**' to color particles marking borders. Color according to
    #                their score (:func:`taddyn.utils.extraviews.tad_border_coloring`)
...
#             return None
    ...
    #     :param kwargs: see :func:`taddyn.utils.extraviews.plot_3d_model` or
    #        :func:`taddyn.utils.extraviews.chimera_view` for other arguments
